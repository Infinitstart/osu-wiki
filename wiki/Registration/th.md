...
1. หลังจาก[การติดตั้ง](/wiki/Installation) osu! จะบอกให้ลงทะเบียน หรือล็อกอินโดยทันทีเมื่อเข้าตัวเกม การที่มาที่หน้านี้แสดงว่าคุณน่าจะยังไม่มีบัญชี กดที่ `สร้างบัญชี` เพื่อสร้างบัญชีได้เลย

   ![ฟอร์มการลงทะเบียนภายในเกม](img/ingame-registration.jpg "The registration form")
...
หลังจากที่อ่านกฎเสร็จแล้ว ก็พร้อมที่จะผจญภัยในโลกของเพลงและจังหวะแล้วหล่ะ หลังจากนี้จะสามารถ[เพิ่มบีทแมพ](/wiki/Installation#adding-beatmapsets) [เปลี่ยนสกิน](/wiki/Skinning) หรือ[สร้างบีทแมพ](/wiki/Beatmapping)ก็ได้ ..หรือจะแวะมาทักทายกันใน[ซับฟอรั่ม Introductions](https://osu.ppy.sh/community/forums/8) ก็ได้นะ
